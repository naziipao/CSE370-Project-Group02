...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2026 at 02:31 PM
...
('100008', 'Sylhet Government College', 14850),
...
(37147258, 'tF8\\@te621L4W?', '2010-01-08', 'Town Hall Road', 'Mymensingh', 'Raihan', 'Ahmed', 'Male', 'raihan.ahmed@gmail.com', 'Diamond', 2240, 68.1),
...
(208595783, 'pR8,kRBcx\'m`B)1', '2004-04-06', 'Road 11, Nasirabad', 'Chattogram', 'Nusrat', 'Jahan', 'Female', 'nusrat.jahan@gmail.com', 'Gold', 730, 34.8),
...
('WAL002', 730, 208595783, '2026-07-02', 7),
...
('WAL008', 1740, 37147258, '2026-07-08', 11),
...
--
ALTER TABLE `deposit`
  MODIFY `deposit_seq` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `pickup_request`
--
ALTER TABLE `pickup_request`
  MODIFY `pickup_seq` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
